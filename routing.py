...
/train/<deck_name>/<front>/: Train a specific deck-front pair.
/learn/<deck_name>/<front>/:  Learn new cards.
"""
...
def browse_deck(deck_name: str):
    ...
    if request.method == "POST":
        if request.form["action"] == "edit":
            deck.edit_card(request.form["id_"], request.form)
        if request.form["action"] == "add":
            deck.add_card(request.form)
        if request.form["action"] == "delete":
            deck.delete_card(request.form["id_"])
